    ...
    <div style="width: 64%;margin-left: 1rem;font-size: 1.5rem;background-color: white;padding: 2rem;border-radius: 1rem;color:#0066cc;margin-top: 2rem;float: left;height: 32rem;">
        ...
        <div class="form-row">
            ...
            <div style="width: 100%;" id="addControl">
                <button onclick="addItemToDetail();" type="submit" class="btn btn-primary" style="background-color: #0066cc;color: white;font-size: 1em;margin-top: 0.5rem;float: right;margin-left:1rem; z-index: 99;">Thêm Chi Tiết</button>
                <button onclick="refreshInput();" type="submit" class="btn btn-primary" style="background-color: white;color: #0066cc;font-size: 1em;margin-top: 0.5rem;float: right;margin-left: 2rem; z-index: 99;">Làm Lại</button>
            </div>
            <div style="width: 100%;" id="editControl">
                <button onclick="addItemToDetail();" type="submit" class="btn btn-primary" style="background-color: #0066cc;color: white;font-size: 1em;margin-top: 0.5rem;float: right;margin-left:1rem; z-index: 99;">Thêm Chi Tiết</button>
                <button onclick="cancelEditItem();" type="submit" class="btn btn-primary" style="background-color: white;color: #0066cc;font-size: 1em;margin-top: 0.5rem;float: right;margin-left: 2rem; z-index: 99;">Hủy Bỏ</button>
            </div>
        </div>
    </div>


    <table id="tableContent" class="table" style="width: 90%;margin-left: 5%;background-color: white;margin-top: 2odeoderem;float: left;margin-top:50px;">
                </table>
